const en = {
  ...
  address: 'Address',
    ...
    containerText: "It's all at your fingertips -- the restaurants you love. Find the right food to suit your mood, and make the first bite last. Go ahead, download us.",
    ...
    restaurantDeliver: "We are asking the restaurant how long it will take to deliver your food", 
    riderDeliver: "We are asking the rider how long it will take to deliver your food",
    orderPending: "Your order is still pending",
    areYouSure: "Are you sure?",
    clearCartText: "By changing restaurant, the items you`ve added to cart will be cleared",
    ok: "OK",
    cancel: "CANCEL",
    submit: 'Submit',
  ...
  demo: "Demo",
  getQuote: "Get Quote",
  restaurantCloseText: "The restaurant is closed right now. Check out others that are open or take a look at the menu to plan for your next meal.",
  ...
  passwordErr1: "Invalid Password. Password must contain at least 1 capital letter, 1 small letter, and 1 number.",
  passwordErr2: "Invalid Password",
  generalErr: "Something is missing",
  verifyEmail: "Verify your email",
  enterOtp: "Please enter the OTP we sent to your email updated",
