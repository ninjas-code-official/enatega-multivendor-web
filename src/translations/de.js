const de = {
    ...
    containerText: "Alles liegt in deiner Handfläche – die Restaurants, die du liebst. Finde das richtige Essen, um deine Stimmung zu treffen, und mache den ersten Bissen zum Erlebnis. Los, lade uns herunter.",
    ...
    differentSections: "Funktion für verschiedene Abschnitte zur Förderung von Restaurants",
    previousOrder: "Vorherige Bestellhistorie und Hinzufügen von Lieblingsrestaurants",
    ...
    restaurantDeliver: "Wir fragen das Restaurant, wie lange es dauern wird, um Ihr Essen zu liefern", 
    riderDeliver: "Wir fragen den Fahrer, wie lange es dauern wird, um Ihr Essen zu liefern",
    orderPending: "Ihre Bestellung ist noch ausstehend",
    areYouSure: "Bist du sicher?",
    clearCartText: "Durch den Wechsel des Restaurants werden die Artikel in deinem Warenkorb gelöscht",
    ok: "OK",
    cancel: "Abbrechen",
    submit: 'einreichen',
  ...
  restaurantCloseText: "Das Restaurant ist derzeit geschlossen. Schauen Sie sich andere offene Restaurants an oder werfen Sie einen Blick auf die Speisekarte für Ihre nächste Mahlzeit.",
  ...
  passwordErr1: "Ungültiges Passwort. Das Passwort muss mindestens 1 Großbuchstaben, 1 Kleinbuchstaben und 1 Zahl enthalten.",
  passwordErr2: "Ungültiges Passwort",
  generalErr: "Etwas fehlt",
  verifyEmail: "Bestätigen Sie Ihre E-Mail",
  enterOtp: "Bitte geben Sie den OTP ein, den wir an Ihre aktualisierte E-Mail gesendet haben",
  ...
  anySpecific: 'Irgendwelche spezifischen Vorlieben? Lassen Sie es das Restaurant wissen.',
