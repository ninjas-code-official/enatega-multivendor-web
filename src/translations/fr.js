export default {
  ...
  passwordInfo: "Informations de mot de passe",
    ...
    containerText: "Tout est à portée de main - les restaurants que vous adorez. Trouvez la nourriture idéale pour satisfaire vos envies et faites durer le plaisir dès la première bouchée. Allez-y, téléchargez-nous.",
    findingAddress: "Trouver une adresse en utilisant l'intégration GPS",
    zonesFunctionality: "Fonctionnalité de zones pour les restaurants et les livreurs",
    ...
    differentSections: "Fonctionnalité de différentes sections pour promouvoir les restaurants",
    previousOrder: "Historique des commandes précédentes et ajout de restaurants favoris",
    ourDelivery: "Notre système de gestion des livraisons est conçu pour l'avenir",
    ...
    restaurantDeliver: "Nous demandons au restaurant combien de temps il faudra pour livrer votre nourriture.", 
    riderDeliver: "Nous demandons au livreur combien de temps il faudra pour livrer votre nourriture",
    orderPending: "Votre commande est toujours en attente",
    areYouSure: "Êtes-vous sûr ?",
    clearCartText: "En changeant de restaurant, les articles que vous avez ajoutés au panier seront supprimés",
    ok: "OK",
    cancel: "ANNULER",
    submit: 'Soumettre',
  ...
  restaurantCloseText: "Le restaurant est actuellement fermé. Découvrez les autres restaurants ou consultez le menu pour planifier votre prochain repas.",
  ...
  passwordErr1: "Mot de passe invalide. Le mot de passe doit contenir au moins 1 lettre majuscule, 1 lettre minuscule et 1 chiffre.",
  passwordErr2: "Mot de passe invalide",
  generalErr: "Quelque chose manque",
  verifyEmail: "Vérifiez votre e-mail",
  enterOtp: "Veuillez entrer le code OTP que nous avons envoyé à votre e-mail mis à jour",
